...
class Level1(GameObject):
    ...
    def __init__(self, shader, position, rotation=Vector(0, 0, 0), scale=Vector(0, 0, 0), material=Material(), visible=True) -> None:
        ...
        self.extra_crate_1 = Crate(shader, Point(3, 0.75, 3), Vector(0, 0, 0), Vector(1.5, 1.5, 1.5))
        self.extra_crate_2 = Crate(shader, Point(-4, 0.5, 5), Vector(0, 0, 0), Vector(1.5, 1.0, 1.5))
        self.extra_crate_3 = Crate(shader, Point(7, 1.0, -5), Vector(0, 0, 0), Vector(2.0, 2.0, 2.0))
        self.extra_crate_4 = Crate(shader, Point(-5, 0.6, 7), Vector(0, 0, 0), Vector(1.2, 1.2, 1.2))
        self.extra_crate_5 = Crate(shader, Point(0, 0.2, 0), Vector(0, 0, 0), Vector(1, 1, 1))
        self.extra_crate_6 = Crate(shader, Point(-8, 0.2, 8), Vector(0, 0, 0), Vector(2, 2, 2))
        self.extra_crate_7 = Crate(shader, Point(5, 0.2, -8), Vector(0, 0, 0), Vector(1.5, 1.5, 1.5))
        self.extra_crate_8 = Crate(shader, Point(-2, 0.2, -6), Vector(0, 0, 0), Vector(2.5, 1, 1))
        ...
        self.cubes.append(self.extra_crate_1)
        self.cubes.append(self.extra_crate_2)
        self.cubes.append(self.extra_crate_3)
        self.cubes.append(self.extra_crate_4)
        self.cubes.append(self.extra_crate_5)
        self.cubes.append(self.extra_crate_6)
        self.cubes.append(self.extra_crate_7)
        self.cubes.append(self.extra_crate_8)
